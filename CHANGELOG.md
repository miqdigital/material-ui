...
- 📦 Start support for Preact (#15401).
...
We have entered the beta phase of v4. We are very grateful to all the contributors that have helped us so far. We don't plan any more breaking changes.
We hope we can release v4 on May 15th, one year after v1.
We encourage you to try the beta out.
We provide an [upgrade guide](https://next.material-ui.com/guides/migration-v3/) to ease the transition.
You will learn more about v4 in the final release blog post.
